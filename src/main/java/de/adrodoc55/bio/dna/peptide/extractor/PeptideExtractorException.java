 ...
 * @author Adrodoc55
 */
public class PeptideExtractorException extends Exception {
  private static final long serialVersionUID = 1L;

  public PeptideExtractorException() {
    super();
  }

  public PeptideExtractorException(String message) {
    super(message);
  }

  public PeptideExtractorException(Throwable cause) {
    super(cause);
  }

  public PeptideExtractorException(String message, Throwable cause) {
    super(message, cause);
  }
}
